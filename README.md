...
## InfraGasSegDataset
We propose a high-quality real-world InfraGasSegDataset, containing 1424 images.
### Dataset Access  
...
For detailed setup instructions, we recommend referring to the [MMSegmentation repository](https://github.com/open-mmlab/mmsegmentation). Our test environment is Pytorch2.0.0+cu11.8 and mmcv2.2.0.
```
conda create -n GasUNet python==3.8
conda activate GasUNet
pip install torch==2.0.0 torchvision==0.18.1 torchaudio==2.3.1 --index-url https://download.pytorch.org/whl/cu118
