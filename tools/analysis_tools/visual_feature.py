...
import warnings
# 精准屏蔽该警告（不影响其他警告）
warnings.filterwarnings('ignore', message='Since the spatial dimensions of overlaid_image')
...
def main():
    ...
    source = [
        'backbone.c_branch_layers.0.0.conv1.conv',
        'backbone.c_branch_layers.0.0.conv2.conv',
        'backbone.c_branch_layers.0.1.conv1.conv',
        'backbone.c_branch_layers.0.1.conv2.conv',
        'backbone.c_branch_layers.0.2.conv1.conv',
        'backbone.c_branch_layers.0.2.conv2.conv',
        'backbone.c_branch_layers.1.0.conv1.conv',
        'backbone.c_branch_layers.1.0.conv2.conv',
        'backbone.c_branch_layers.1.1.conv1.conv',
        'backbone.c_branch_layers.1.1.conv2.conv',
        'backbone.c_branch_layers.1.2.conv1.conv',
        'backbone.c_branch_layers.2.0.conv1.conv',
        'backbone.c_branch_layers.2.0.conv2.conv',
        'backbone.c_branch_layers.2.0.conv3.conv',
        'backbone.c_branch_layers.2.1.conv1.conv',
        'backbone.c_branch_layers.2.1.conv2.conv',
        'backbone.c_branch_layers.2.1.conv3.conv',
        'backbone.e_branch_layers.0.conv1.conv',
        'backbone.e_branch_layers.0.conv2.conv',
        'backbone.e_branch_layers.1.0.conv1.conv',
        'backbone.e_branch_layers.1.0.conv2.conv',
        'backbone.e_branch_layers.1.0.conv3.conv',
        'backbone.block1.self_attention.conv2d',
        'backbone.block2.self_attention.conv2d',
        'decode_head.c_head.conv.conv',
        'decode_head.e_head.conv',
        'decode_head.e_head.conv.conv'
    ]
